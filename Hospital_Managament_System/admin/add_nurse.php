                    ...
                    <form action="code.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="button" class="btn btn-primary" id="modalButton" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Add Nurse</button>
                            </div>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="add_nurse" class="btn btn-primary">Save changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
