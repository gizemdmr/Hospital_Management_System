                ...
                <div class="card-body">
                    <form action="code.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="">Medicine Price (TL)</label>
                            ...
                            <div class="col-md-12 mb-3">
                                <button type="button" class="btn btn-primary" id="modalButton" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Add Medicine</button>
                            </div>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            İlaç Eklenecek. Onaylıyor musunuz?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" name="add_medicine" class="btn btn-primary">Save changes</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
