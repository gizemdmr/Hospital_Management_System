...
<div class="container-fluid px-4">
    <h1 class="mt-2">Nurse</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Dashboard</li>
        <li class="breadcrumb-item">Nurse Info</li>
    </ol>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Nurse's Info
                ...
                <div class="card-body">
                    ...
                    if (isset($_GET['nurse_id'])) {
                        ...
                        $users = "SELECT * FROM nurse WHERE nurse_id='$nurse_id'";
                        ...
                        if (mysqli_num_rows($users_run) > 0) {
                            foreach ($users_run as $user) {
                                ...
                                <form action="code.php" method="POST">
                                    <input type="hidden" name="nurse_id" value="<?= $user['nurse_id'] ?>">
                                    <div class="row">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="update_nurse" class="btn btn-primary">Save changes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
